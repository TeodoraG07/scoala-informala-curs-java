...
public class Logan extends Dacia implements Vehicle {
    ...
    public Logan(
            int fuelTankSize,
            String chassisNumberString) {
        super("Logan", fuelTankSize, "Diesel", 8, 7.8f, 60, 89, chassisNumberString);
        ;
    }

    @Override
    public void start() {
        System.out.println("Logan is starting...");

    }

    @Override
    public void stop() {
        System.out.println("Logan is stopping...");
