...
public class VWGolf extends Volkswagen implements Vehicle {
    public VWGolf(String model,
                  int fuelTankSize,
                  String fuelType,
                  int gears,
        ...
        super(model, fuelTankSize, fuelType, gears, consumptionPer100Km, availableFuel, tireSize, chassisNumberString);
    }

    public VWGolf(
            int fuelTankSize,
            String chassisNumberString) {
        super("VWGolf", fuelTankSize, "Diesel", 8, 7.8f, 60, 89, chassisNumberString);
        ;
    }

    @Override
    public void start() {
        System.out.println("VwGolf is starting...");

    }

    @Override
    public void stop() {
        System.out.println("VwGolf is stopping...");
